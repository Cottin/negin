...
[ːgreen, ːraised, ːveryBad, ːhref, ːred, ːhue, ːicon, ːmood, ːmodal, ːlight, ːgrey, ːveryGood, ːindigo, ːfree, ːbrown, ːblue, ːbeveled, ːkind, ːpink, ːcustom, ːsubmit, ːselected, ːtext, ːdark, ːlink, ːwait, ːlinkBlank, ːonClick, ːgood, ːlook, ːsquare, ːdisabled, ːbad] = ['green', 'raised', 'veryBad', 'href', 'red', 'hue', 'icon', 'mood', 'modal', 'light', 'grey', 'veryGood', 'indigo', 'free', 'brown', 'blue', 'beveled', 'kind', 'pink', 'custom', 'submit', 'selected', 'text', 'dark', 'link', 'wait', 'linkBlank', 'onClick', 'good', 'look', 'square', 'disabled', 'bad'] #auto_sugar
